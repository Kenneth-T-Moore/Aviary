...
sub = model.add_subsystem('ode', EnergyStateODE(num_nodes=1), promotes=['*'])
sub.add_subsystem('rc_engine', UAVPropMission(num_nodes=1), promotes=['*'])
...
prob.set_val(Dynamic.Mission.VELOCITY, 10, units='mi/h')
...
prob.set_val(Dynamic.Vehicle.Propulsion.THROTTLE, 0.7)
